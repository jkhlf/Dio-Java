...
public class ConjuntoConvidados {
    ...
    public static void main(String[] args) {
        ...
        conjuntoConvidados.adicionarConvidado("Fernando", 1234);
        conjuntoConvidados.adicionarConvidado("Tio Phill", 1260);
        conjuntoConvidados.adicionarConvidado("Pedrinho", 1200);
        conjuntoConvidados.adicionarConvidado("Lara", 1236);
